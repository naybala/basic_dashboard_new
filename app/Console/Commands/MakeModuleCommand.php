...
class MakeModuleCommand extends Command
{
    ...
    public function getRepositoryInterfaceFilePath()
    {
        ...
        $modelName = $this->filterModelName($this->getSingularClassName($this->argument('name')));
        $moduleName = $this->filterModuleName($this->argument('name'));
        return base_path($moduleName . DIRECTORY_SEPARATOR . "Foundations" . DIRECTORY_SEPARATOR . "Domain" . DIRECTORY_SEPARATOR . $folderName . DIRECTORY_SEPARATOR . "Repositories") . DIRECTORY_SEPARATOR . $modelName . "RepositoryInterface.php";
    }
